          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-slate-900/50 border border-slate-700 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
              />
            </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-sm text-slate-300">{result.user_email}</div>
                          {result.user_specialty && (
                            <div className="text-xs text-slate-300">{result.user_specialty}</div>
                          )}
                        </div>
                      </div>
                    </td>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="p-4 bg-teal-500/10 rounded-xl border border-teal-500/20 text-center">
                      ...
                      <div className="text-sm text-slate-300">Cases Completed</div>
                    </div>
                    ...
                    <div className="p-4 bg-green-500/10 rounded-xl border border-green-500/20 text-center">
                      ...
                      <div className="text-sm text-slate-300">Avg per Case</div>
                    </div>
                  </div>
                  ...
                  <div className="max-h-96 overflow-y-auto rounded-xl border border-slate-700/50">
                    <table className="min-w-full divide-y divide-slate-700/50">
                      <thead className="bg-slate-900/50 sticky top-0">
                        <tr>
                          <th className="px-4 py-2 text-left text-xs font-medium text-slate-300 uppercase">Case</th>
                          <th className="px-4 py-2 text-left text-xs font-medium text-slate-300 uppercase">Answer</th>
                          <th className="px-4 py-2 text-left text-xs font-medium text-slate-300 uppercase">Time</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-slate-700/50">
