        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            <div className="bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-xl p-5 hover:border-teal-500/30 transition-colors">
              ...
              <p className="text-slate-400 text-xs lg:text-sm">High-resolution slide viewing with zoom and pan controls</p>
            </div>
            <div className="bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-xl p-5 hover:border-teal-500/30 transition-colors">
              ...
              <p className="text-slate-400 text-xs lg:text-sm">Organized test sessions with progress tracking</p>
            </div>
            <div className="bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-xl p-5 hover:border-teal-500/30 transition-colors">
              <div className="w-10 h-10 bg-teal-500/10 rounded-lg flex items-center justify-center mb-3">
              ...
              <p className="text-slate-400 text-xs lg:text-sm">Detailed performance metrics and reporting</p>
            </div>
            <div className="bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-xl p-5 hover:border-teal-500/30 transition-colors">
              <div className="w-10 h-10 bg-cyan-500/10 rounded-lg flex items-center justify-center mb-3">
              ...
              <p className="text-slate-400 text-xs lg:text-sm">Enterprise-grade security for medical data</p>
            </div>
          </div>
        </div>
      </main>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center space-x-4 text-sm">
              <a
                ...
                className="inline-flex items-center text-slate-400 hover:text-teal-400 transition-colors"
              >
